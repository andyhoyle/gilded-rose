...
Scenario: "Aged Brie" actually increases in Quality the older it gets but also doubles after sell in date
    Given a list of items in stock:
	    | Name      | SellIn | Quality |
	    | Aged Brie | 0      | 4       |
    When a single day has elapsed
    Then the quality of the item "Aged Brie" should be 6

Scenario: "Aged Brie" actually increases in Quality the older it gets but also doubles after sell in date but cannot exceed 50
    Given a list of items in stock:
	    | Name      | SellIn | Quality |
	    | Aged Brie | 0      | 49      |
    When a single day has elapsed
...
Scenario: BSP Max Quality 50 normal time
    Given a list of items in stock:
	    | Name                                      | SellIn | Quality |
...
Scenario: BSP Max Quality 50 within 10 days
    Given a list of items in stock:
	    | Name                                      | SellIn | Quality |
...
Scenario: BSP Max Quality 50 within 5 days
    Given a list of items in stock:
	    | Name                                      | SellIn | Quality |
