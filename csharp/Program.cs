    ...
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            IList<Item> Items = new List<Item>{
                ...
                new Item { Name = GildedRose.BACKSTAGE_PASS, SellIn = 15, Quality = 20 },
                new Item { Name = GildedRose.BACKSTAGE_PASS, SellIn = 10, Quality = 49 },
                new Item { Name = GildedRose.BACKSTAGE_PASS, SellIn = 5, Quality = 49 },
